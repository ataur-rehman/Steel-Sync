      ...
      <div className="p-6 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex items-center space-x-4">
            <button
              onClick={() => navigateTo('/stock/receiving')}
            ...
            >
              ...
              <span>Back to Receiving List</span>
            </button>
            <div>
              <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Receiving Record Not Found</h1>
              <p className="mt-1 text-sm text-gray-500">The requested receiving record could not be found</p>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex items-center space-x-4">
          <button
            onClick={() => navigateTo(getFromPage() || '/stock/receiving')}
            className="flex items-center space-x-2 px-3 py-2 border border-gray-300 rounded-md hover:bg-gray-50 transition-colors"
          >
            <ChevronLeft className="h-4 w-4" />
            <span>Back</span>
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 tracking-tight">
              Receiving #{formatReceivingNumber(receiving.receiving_number)}
            </h1>
            <p className="mt-1 text-sm text-gray-500">
              Received on {formatDate(receiving.date)} • {items.length} items
            </p>
          </div>
        </div>
            ...
            <div className="card p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <span className="text-sm text-gray-900">{formatDate(receiving.date)}</span>
